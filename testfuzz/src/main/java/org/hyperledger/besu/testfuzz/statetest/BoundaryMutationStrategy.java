 ...
 * Replaces numeric values with AFL-inspired boundary/interesting values
 * that are likely to trigger edge case bugs.
 * Ported from goevmlab mutations/boundary.go
 */
public class BoundaryMutationStrategy implements MutationStrategy {
  ...
  private static final String[] INTERESTING_VALUE_BOUNDARIES = {
      ...
      // "0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff", // Max uint256 - disabled
  ...
  private static final BoundaryTarget[] BOUNDARY_TARGETS = {
      ...
      new BoundaryTarget(
          "transaction", "value", true, INTERESTING_VALUE_BOUNDARIES, "value", true),
      new BoundaryTarget(
      ...
      new BoundaryTarget(
          ...
          "currentTimestamp",
          false,
          INTERESTING_TIMESTAMP_BOUNDARIES,
          "timestamp",
          false),
      new BoundaryTarget(
          "env",
          "currentNumber",
          false,
          INTERESTING_BLOCK_NUMBER_BOUNDARIES,
          "blockNumber",
          false),
      new BoundaryTarget(
